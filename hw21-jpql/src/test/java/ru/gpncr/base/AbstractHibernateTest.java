package ru.gpncr.base;

import static ru.gpncr.demo.DbServiceDemo.HIBERNATE_CFG_FILE;
...
import ru.gpncr.core.repository.DataTemplateHibernate;
import ru.gpncr.core.repository.HibernateUtils;
import ru.gpncr.core.sessionmanager.TransactionManagerHibernate;
import ru.gpncr.crm.dbmigrations.MigrationsExecutorFlyway;
import ru.gpncr.crm.model.Client;
import ru.gpncr.crm.service.DBServiceClient;
